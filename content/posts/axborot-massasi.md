...
Biroq, fizika qonunlari bu nuqtai nazarni rad etadi.

Nizomsiz olamimizda termodinamika va kvant mexanikasi butunlay boshqa haqiqatni taqdim etmoqda: **axborot shunchaki matematikaning elementi emas, u fizika obyekti, u energiya va eng muhimi — u massaga ega.**
...
Ajablanarlisi shundaki, Shennon tenglamasi 19-asrda Lyudvig Boltzmann tomonidan statistika va termodinamika uchun kashf etilgan entropiya formulasining aniq nusxasi edi:
...
Landauer isbotladi: 1 bit axborotni o‘chirish (ya’ni uning entropiyasini kamaytirish) muqarrar ravishda atrof-muhitga issiqlik ajratadi. Bu termodinamikaning ikkinchi qonunidan kelib chiqadigan mutlaq jismoniy...

...va massaga ega ekvivalentlik haqida bo'ladi:

\[\Delta E = k_B \cdot T \cdot \ln(2)\]
...
Eynshteynning mashhur $E = mc^2$ formula energiya va massaning bir-biriga ekvivalentligini ko‘rsatgan bo‘lsa, Vopson axborot ham ushbu zanjirning uchinchi halqasi ekanligini ta’kidladi. Bitni o‘chirish energiya talab qilgan bo‘lsa va energiya massaga teng bo‘lsa, har bir bit axborot o‘zining fundamental fizik massasiga ega.

Vopson tenglamasiga ko‘ra, xona haroratida 1 bit axborotning massasi taxminan quyidagiga teng:
...
Reversiv hisoblashda mantiqiy apparat va algoritmlar ishga solinadi, ularda **hech bir bit yo‘qotilmaydi va o‘chirilmaydi**. Toffoli va Fredkin ventillari kirish signallarining har birini saqlab qoladi. Bu dasturchilar uchun nimani anglatadi?
1. **Garbage Collection qayta ko‘rib chiqilishi:** Xotira qaytariluvchan mantiqiy operatsiyalar orqali "antisimetrik" bo‘lib qayta ishlatilishi shart.
...
1. **Abstraktsiya illyuziyasining barham topishi:** AI modellari koinot entropiyasini tezlatilmoqda.
...
2. **Energiya davri:** Energiya manbalarini jilovladik.
3. **Axborot davri:** Axborotni kashf eta oldik, lekin uni moddiylikdan ayro deb o‘yladik.

Bugun biz to‘rtinchi — **Metafizik birlashuv davri** bosqichidamiz. Melvin Vopson, Rolf Landauer va boshqalarning izlanishlari isbotlamoqda: **Materiya, Energiya va Axborot — bitta obyektning uch xil ko‘rinishidir.**

Dasturchi shunchaki kod yozmaydi — u fizik materiyaning entropiyasini o‘zgartiradi. Astronom shunchaki osmonga qaramaydi — u koinotdagi kvant axborotini o‘qidigan ilmiy qahramondir.

Eng yengil kod dunyosida **eng yaxshi kod — bu eng kam o‘chirilgan bitdir.**