...
O‘tkazilgan tadqiqotlar shuni ko‘rsatadiki, bilim xodimlarining kunlik vaqtining 40%dan ortiq qismi bandligini isbotlashga ketmoqda. Bu holat quyidagicha aks etmoqda:
- Xatlarga va xabarlarga tezkor javob qaytarish;
- Taqvimda keraksiz uchrashuvlarni to‘ldirish;
- Kichik funksiyalarni ko‘plab commits va pull request'lar bilan bo'lish;
- Sodda muammolarni yechish o‘rniga, uzoq davom etadigan muhokamalar yaratish.
...
Natijada:
- **Kompaniya uchun**: Loyiha arxitekturasi murakkablashadi, xarajatlar oshadi, texnik qarz ortadi.
- **Mutaxassis uchun**: U sun'iy murakkablik yaratishni o‘rganadi va karyerasi aldanishlar ustiga quriladi.
...
Minnesota universiteti professori Sofi Leroyning tadqiqotlariga ko‘ra, A-vazifadan B-vazifaga o'tishda diqqatingizning bir qismi A-vazifada qolib ketadi (Attention Residue).

Bu *"sayoz mehnat"* (Shallow Work) sindromiga olib keladi. Mutaxassis vaqtining ko'pini sayoz ishga sarflaganda, quyidagilar sodir bo'ladi:
- **Fundamentallikni yo‘qotish**: Yangi va chuqur kontseptsiyani o‘rganish imkoniyati yo'qoladi.
...
2. **Avtomatlashtirish**: Avtomatik scriptlar kundalik monotoniya ishlarni yengillashtiradi.
3. **Asosli "yo'q" deyish**: Asossiz funksiyalarni yaratishdan bosh tortish orqali resurslarni saqlash.
4. **Bilim va ustozlik**: Jamoa a'zolarining fikrlash darajasini oshirish.
