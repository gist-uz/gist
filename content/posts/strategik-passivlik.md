...
[taxonomies]
tags = ["strategik-passivlik", "harakat-illyuziya", "kognitiv-bandwidth", "suniy-ong"]
+++
```
...
Biroq, murakkab tizimlar, dasturiy injiniring va strategik menejment olamida paradoksal reallik mavjud: **uzluksiz harakat va giper-unumdorlilk ko‘pincha strategik korlikka olib keladi.**
...
Karyerada inqiroz yoki noaniqlik paydo bo‘lganda, ko‘pchilik mutaxassislar avtomatik ravishda **reaktiv harakat** rejimiga o‘tadilar:

* Dasturchi kod arxitekturasini qayta ko‘rib chiqish o‘rniga, yangi va keraksiz funksionallar yozishga kirishadi.
* Startap asoschisi mahsulotning bozordagi o‘rnini chuqur tahlil qilish o‘rniga, marketingga ko‘proq pul sarflay boshlaydi.
* Menejer jamoa ichidagi sistemali muammoni hal qilish o‘rniga, uchrashuvlar sonini ko‘paytiradi.

Bu xatti-harakatlar ishliqlik illyuziyasini beradi. Biz harakat qilayotganimizda miyamiz dofamin ajratadi — o‘zimizni foydali ish bilan mashg‘uldek his qilamiz. Ammo tezlik (speed) va vektor (velocity) o‘rtasida tub farq bor: tezlik — bu qanchalik tez harakatlanayotganingiz, vektor esa qaysi yo‘nalishda ketayotganingizdir. 
...
1. **Fokuslangan rejim (Focused mode):** Aniq bir topshiriqni bajarganda, algoritmlarni ketma-ket yechayotganda faollashadi.
2. **Diffuz rejim (Diffuse mode):** Inson dam olayotganda, sayr qilayotganda yoki hech qanday aniq maqsadga yo‘naltirilmagan holatda bo‘lganda yoqiladi.

Eng murakkab kashfiyotlar, arxitekturaviy yechimlar va strategik burilishlar aynan diffuz rejimda sodir bo‘ladi. Agar miya doimiy ravishda topshiriqlar, xabarlar va bajarilishi kerak bo‘lgan ishlar bilan to‘la bo‘lsa, yangi bog‘liqliklarni va ikkinchi darajali oqibatlarni ko‘ra olmaydi.

```
[Doimiy Ijro Rejimi]  ---> (Kognitiv Charchash) ---> (Lokal Optimalda qolib ketish)
                                                                 |
[Strategik Passivlik] ---> (Diffuz Fikrlash)  ---> (Global Optimalni topish)
```

Natijada mutaxassis **"Lokal Optimal"** tuzog‘iga tushib qoladi. Matematik optimallashuvda bu — tepalikning eng yuqori nuqtasidasiz, lekin yoningizda undan o‘n baravar balandroq tog‘ borligini ko‘rmaysiz. Chunki pastga tushib, qarash uchun harakatni to‘xtatishingiz kerak.
...
Qarorlar olamida esa harakatlar va natijalar o‘rtasidagi bog‘liqlik chiziqli emas (non-linear).

Imagine: 
* **A-muhandis:** Haftasiga 60 soat ishlaydi, 50 ta xatoni tuzatadi.
* **B-muhandis:** Haftasiga 20 soat o‘ylaydi, tizim yuklamasini kamaytiradi.
...
* Hech qanday uchrashuv bo‘lmaydi.
* Notifikatsiyalar o‘chiriladi.
...
Bunday davrda insonning asosiy kognitiv ustunligi nima?

* **Yo'nalishni to'g'ri tanlashda (Judgment).**
* **Nima qilish kerakligini emas, nima qilmaslik kerakligini aniqlashda (Discernment).**
* **Murakkab kontekstlarni tahlil qilish uchun ongli to'xtashda (Systemic Thinking).**
...
Karyeraviy o‘sish — yugurish yo‘lakchasida chopish emas, to‘g‘ri cho‘qqini tanlash va u yo'lni topish demak, demakdir. Keyingi safar taqvimingiz to‘lib ketsa yoki inqirozni his qilganingizda, shoshilmang. Kofeingizni oling, barcha ekranlarni o‘chiring va o‘ylang. Ba'zan eng inqilobiy ishingiz — **hech narsa qilmaslikdir.**